...
public class SpuController {
    ...
    public ResponseVo<PageResultVo> findPageCategory(@PathVariable("categoryId")Long categoryId,PageParamVo pageParamVo){
         PageResultVo pageResultVo=spuService.findPageCategory(categoryId,pageParamVo);
