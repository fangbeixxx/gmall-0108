...
public class CategoryController {
    ...
    //根据三级分类id查询一二三级分类
    @GetMapping("subThree/{cid}")
    public ResponseVo<List<CategoryEntity>>  querylv123WithSubsById(@PathVariable("cid")Long cid){
        List<CategoryEntity> categoryEntityList=categoryService.querylv123WithSubsById(cid);
    ...
    public ResponseVo<List<CategoryEntity>> queryLvl2WithSubsById(@PathVariable("pid")Long pid){
        List<CategoryEntity> categoryEntities=categoryService.queryLvl2WithSubsById(pid);
