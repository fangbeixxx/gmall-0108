...
public class SpuAttrValueController {
    ...
    public ResponseVo<List<SpuAttrValueEntity>> searchQuerySpuAttrValueById(@PathVariable("cid") Long cid,@RequestParam("spuId") Long spuId){
        List<SpuAttrValueEntity> list=spuAttrValueService.searchQuerySpuAttrValueById(cid,spuId);
