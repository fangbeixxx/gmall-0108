...
public class PmsOssController {
    String accessId = "LTAI5tD9XqTv8w9GonLmxtuX"; // 请填写您的AccessKeyId。
    String accessKey = "iift0B0mNOnEWqAfxpTrzd8ZY2vhqL"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-shanghai.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "fangbeixxx"; // 请填写您的 bucketname 。
