...
public class AttrGroupController {
    ...
    public ResponseVo<List<GroupVo>> queryGroupsWithAttrValuesByCidAndSpuIdAndSkuId(@PathVariable("cid")Long cid,
        ...
        List<GroupVo> groupVos=attrGroupService.queryGroupsWithAttrValuesByCidAndSpuIdAndSkuId(cid,spuId,skuId);
        return  ResponseVo.ok(groupVos);
    }
   @GetMapping("withattrs/{catId}")
   public ResponseVo<List<AttrGroupEntity>> queryCategoriesWithById(@PathVariable("catId")Long catId){
       List<AttrGroupEntity> list=attrGroupService.queryCategoriesWithById(catId);
       return ResponseVo.ok(list);
   }

    @GetMapping("category/{cid}")
    public ResponseVo<List<AttrGroupEntity>> queryCategoriesAttrGroupByPid(@PathVariable("cid") Long cid){
